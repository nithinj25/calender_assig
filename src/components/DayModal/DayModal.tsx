                ...
                <div className="flex gap-2">
                  {MOODS.map(({ type, emoji }) => (
                    <button
                      ...
                      className={cn(
                        "w-12 h-12 flex items-center justify-center text-lg rounded-full transition-all border outline-none",
                        dayData.mood === type
                          ? "bg-accent/20 border-accent shadow-[0_0_15px_rgba(96,165,250,0.3)] scale-110"
                          : "bg-surface-hover border-white/5 hover:bg-white/10 hover:scale-105"
                      )}
